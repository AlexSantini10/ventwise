...
ENTITY_NAME_LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "suggested_comfort_temperature": "Climate-adaptive comfort target",
        ...
        "quiet_hours_start_time": "Quiet hours start time",
        "quiet_hours_end_time": "Quiet hours end time",
    ...
    "it": {
        ...
        "suggested_comfort_temperature": "Target di comfort adattivo al clima",
    ...
    "ru": {
        ...
        "average_perceived_indoor_temperature": "Средняя ощущаемая температура в помещении",
        "perceived_outdoor_temperature": "Ощущаемая температура на улице",
        "effective_comfort_temperature": "Действующая комфортная температура",
        "suggested_comfort_temperature": "Адаптивная целевая комфортная температура",
        "outdoor_temperature": "Температура на улице",
        "outdoor_humidity": "Влажность на улице",
        "wind_speed": "Скорость ветра на улице",
        "recommendation": "Рекомендация",
        "recommendation_score": "Оценка рекомендации",
        "recommendation_reason": "Обоснование рекомендации",
        "perceived_indoor_temperature": "Ощущаемая температура в помещении",
        "temperature": "Температура в помещении",
        "indoor_humidity": "Влажность в помещении",
        ...
        "quiet_hours_active": "Режим тишины активен",
        "quiet_hours_start_time": "Начало режима тишины",
        "quiet_hours_end_time": "Конец режима тишины",
        "notifications_currently_allowed": "Уведомления сейчас разрешены",
        "notification_cooldown_active": "Пауза между уведомлениями активна",
        ...
        "enabled": "Включено",
        "temperature_override_enabled": "Переопределение температуры включено",
        "humidity_override_enabled": "Переопределение влажности включено",
        "temperature_override": "Переопределение температуры",
        "humidity_override": "Переопределение влажности",
    },
    "zh-hans": {
...
def _localized_name(name_key: str, language: str | None) -> str:
    ...
    english_labels = ENTITY_NAME_LABELS["en"]
    return labels.get(
        name_key,
        english_labels.get(name_key, name_key.replace("_", " ").title()),
    )
